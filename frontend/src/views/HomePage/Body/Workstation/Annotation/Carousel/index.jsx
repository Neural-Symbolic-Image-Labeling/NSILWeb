...
export const Carousel = ()=> {
  ...
  const nextSlide = () => {
    ...
    dispatch(setCurrentLabels(currCollection.images[current === length - 1 ? 0 : current + 1].labels[0] === undefined ? "" : currCollection.images[current === length - 1 ? 0 : current + 1].labels[0].name[0]));
  };
  ...
  const prevSlide = () => {
    ...
    dispatch(setCurrentLabels(currCollection.images[current === 0 ? length - 1 : current - 1].labels[0].name[0]));
  };
